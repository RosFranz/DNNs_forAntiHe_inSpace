...
void trainOnMC_mass(TString CLtrainOnMCFile="000", TString CLvalOnISSFile="000", TString AEtrainOnMCFile="000", TString AEvalOnISSFile="000"){
    ...
    for(int i=0; i<aeCutValues.size(); ++i){
        ...
        aeAglVALnegNumSel.push_back("&& MCneg.NEGanomaly_score<"+to_string(aeCutValues.at(i)));
        aeAglVALnegDenomSel.push_back("&& MCneg.NEGanomaly_score<"+to_string(aeCutValues.at(i)));
        ...
        aeAglTESTnegNumSel.push_back("&& ISSneg.NEGanomaly_score<"+to_string(aeCutValues.at(i)));
        aeAglTESTnegDenomSel.push_back("&& ISSneg.NEGanomaly_score<"+to_string(aeCutValues.at(i)));
        ...
        aeNaFVALnegNumSel.push_back("&& MCneg.NEGanomaly_score<"+to_string(aeCutValues.at(i)));
        aeNaFVALnegDenomSel.push_back("&& MCneg.NEGanomaly_score<"+to_string(aeCutValues.at(i)));
        ...
        aeNaFTESTnegNumSel.push_back("&& ISSneg.NEGanomaly_score<"+to_string(aeCutValues.at(i)));
        aeNaFTESTnegDenomSel.push_back("&& ISSneg.NEGanomaly_score<"+to_string(aeCutValues.at(i)));
        if(useSafetyFactor) {
    ...
    for(int i=0; i<clCutValues.size(); ++i){
        //classifier
        clAglVALposNumSel.push_back("&& scores_pos>"+to_string(clCutValues.at(i)));
        clAglVALposDenomSel.push_back("&& scores_pos>"+to_string(clCutValues.at(i)));
        clAglVALnegNumSel.push_back("&& scores_neg>"+to_string(clCutValues.at(i)));
        clAglVALnegDenomSel.push_back("&& scores_neg>"+to_string(clCutValues.at(i)));
        clAglTESTposNumSel.push_back("&& scores_pos>"+to_string(clCutValues.at(i)));
        clAglTESTposDenomSel.push_back("&& scores_pos>"+to_string(clCutValues.at(i)));
        clAglTESTnegNumSel.push_back("&& scores_neg>"+to_string(clCutValues.at(i)));
        clAglTESTnegDenomSel.push_back("&& scores_neg>"+to_string(clCutValues.at(i)));

        clNaFVALposNumSel.push_back("&& scores_pos>"+to_string(clCutValues.at(i)));
        clNaFVALposDenomSel.push_back("&& scores_pos>"+to_string(clCutValues.at(i)));
        clNaFVALnegNumSel.push_back("&& scores_neg>"+to_string(clCutValues.at(i)));
        clNaFVALnegDenomSel.push_back("&& scores_neg>"+to_string(clCutValues.at(i)));
        clNaFTESTposNumSel.push_back("&& scores_pos>"+to_string(clCutValues.at(i)));
        clNaFTESTposDenomSel.push_back("&& scores_pos>"+to_string(clCutValues.at(i)));
        clNaFTESTnegNumSel.push_back("&& scores_neg>"+to_string(clCutValues.at(i)));
        clNaFTESTnegDenomSel.push_back("&& scores_neg>"+to_string(clCutValues.at(i)));
    ...
    for(int i=0; i<aeCutValues.size(); ++i){
        for(int j=0; j<clCutValues.size(); ++j){
            combAglVALposNumSel.push_back("&& MC.anomaly_score<"+to_string(aeCutValues.at(i))+" && scores_pos>"+to_string(clCutValues.at(j)));
            combAglVALposDenomSel.push_back("&& MC.anomaly_score<"+to_string(aeCutValues.at(i))+" && scores_pos>"+to_string(clCutValues.at(j)));
            combAglVALnegNumSel.push_back("&& MCneg.NEGanomaly_score<"+to_string(aeCutValues.at(i))+" && scores_neg>"+to_string(clCutValues.at(j)));
            combAglVALnegDenomSel.push_back("&& MCneg.NEGanomaly_score<"+to_string(aeCutValues.at(i))+"&& scores_neg>"+to_string(clCutValues.at(j)));

            combNaFVALposNumSel.push_back("&& MC.anomaly_score<"+to_string(aeCutValues.at(i))+" && scores_pos>"+to_string(clCutValues.at(j)));
            combNaFVALposDenomSel.push_back("&& MC.anomaly_score<"+to_string(aeCutValues.at(i))+" && scores_pos>"+to_string(clCutValues.at(j)));
            combNaFVALnegNumSel.push_back("&& MCneg.NEGanomaly_score<"+to_string(aeCutValues.at(i))+" && scores_neg>"+to_string(clCutValues.at(j)));
            combNaFVALnegDenomSel.push_back("&& MCneg.NEGanomaly_score<"+to_string(aeCutValues.at(i))+" && scores_neg>"+to_string(clCutValues.at(j)));

            combAglTESTposNumSel.push_back("&& ISS.anomaly_score<"+to_string(aeCutValues.at(i))+" && scores_pos>"+to_string(clCutValues.at(j)));
            combAglTESTposDenomSel.push_back("&& ISS.anomaly_score<"+to_string(aeCutValues.at(i))+" && scores_pos>"+to_string(clCutValues.at(j)));
            combAglTESTnegNumSel.push_back("&& ISSneg.NEGanomaly_score<"+to_string(aeCutValues.at(i))+" && scores_neg>"+to_string(clCutValues.at(j)));
            combAglTESTnegDenomSel.push_back("&& ISSneg.NEGanomaly_score<"+to_string(aeCutValues.at(i))+"&& scores_neg>"+to_string(clCutValues.at(j)));

            combNaFTESTposNumSel.push_back("&& ISS.anomaly_score<"+to_string(aeCutValues.at(i))+" && scores_pos>"+to_string(clCutValues.at(j)));
            combNaFTESTposDenomSel.push_back("&& ISS.anomaly_score<"+to_string(aeCutValues.at(i))+" && scores_pos>"+to_string(clCutValues.at(j)));
            combNaFTESTnegNumSel.push_back("&& ISSneg.NEGanomaly_score<"+to_string(aeCutValues.at(i))+" && scores_neg>"+to_string(clCutValues.at(j)));
            combNaFTESTnegDenomSel.push_back("&& ISSneg.NEGanomaly_score<"+to_string(aeCutValues.at(i))+" && scores_neg>"+to_string(clCutValues.at(j)));
    ...
    for(int i_tree=0; i_tree<2; i_tree++){ //loop on CLtrees
        ...
        for(int j_rig=0; j_rig<TotRig; j_rig++){ //loop on rig
            if(i_tree%2==0) { // Only positives
                ...
                drawclRCSTEST.push_back("scores_pos:log10(abs("+NameR.at(j_rig)+"))>>+"+nRCSTEST);
                ...
                drawCSinvMassTEST.push_back("ISS_pos.scores_pos:1./((2.*abs("+NameR.at(j_rig)+")*sqrt(1-pow(beta_rich,2)))/(beta_rich*0.9315))");
                ...
                drawaeRAS.push_back("MCneg.NEGanomaly_score:log10(abs("+NameR.at(j_rig)+"))>>+"+nRAS);
                drawclRCSTEST.push_back("scores_neg:log10(abs("+NameR.at(j_rig)+"))>>+"+nRCSTEST);
                drawaeRASTEST.push_back("ISSneg.NEGanomaly_score:log10(abs("+NameR.at(j_rig)+"))>>+"+nRASTEST);
                ...
                drawASinvMass.push_back("MCneg.NEGanomaly_score:1./((2.*abs("+NameR.at(j_rig)+")*sqrt(1-pow(beta_rich,2)))/(beta_rich*0.9315))");
                drawCSinvMassTEST.push_back("ISS_neg.scores_neg:1./((2.*abs("+NameR.at(j_rig)+")*sqrt(1-pow(beta_rich,2)))/(beta_rich*0.9315))");
                drawASinvMassTEST.push_back("ISSneg.NEGanomaly_score:1./((2.*abs("+NameR.at(j_rig)+")*sqrt(1-pow(beta_rich,2)))/(beta_rich*0.9315))");
            }
    ...
    CLtrees.at(3)->Scan("((2.*abs(Rinner)*sqrt(1-pow(beta_rich,2)))/(beta_rich*0.9315)):scores_neg:NEGanomaly_score",TotSelection.Data());
    ...
    CLtrees.at(1)->Scan("((2.*abs(Rinner)*sqrt(1-pow(beta_rich,2)))/(beta_rich*0.9315)):scores_neg:NEGanomaly_score:weight",TotSelection.Data());
