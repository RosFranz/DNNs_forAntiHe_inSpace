...
void dCor(){
    ...
    myMC.at(1)->SetBranchAddress("scores",&score);
    myMC.at(1)->SetBranchAddress("anomaly_score",&as);
    ...
    */
    ...
    myISS.at(3)->SetBranchAddress("scores",&score);
    myISS.at(3)->SetBranchAddress("anomaly_score",&as);
